...
INSERT INTO tb_uf (nm_uf, id_pais) 
VALUES ('São Paulo', 1), 
       ('Rio de Janeiro', 1), 
       ('Nova Iorque', 2), 
       ('Califórnia', 2), 
...
INSERT INTO tb_cidade (nm_cidade, id_uf) 
VALUES ('São Paulo', 1), 
       ('Rio de Janeiro', 2), 
       ('Nova Iorque', 3), 
       ('Los Angeles', 4), 
...
INSERT INTO tb_bairro (nm_bairro, id_cidade) 
VALUES ('Jardins', 1), 
       ('Copacabana', 2), 
       ('Manhattan', 3), 
       ('Beverly Hills', 4), 
...
INSERT INTO tb_endereco (id_bairro) 
VALUES (1), (2), (3), (4), (5), (6);

-- Preencher a tabela de usuários
INSERT INTO tb_usuario (nm_usuario, senha_usuario, email_usuario, id_assinatura) 
VALUES ('Álvaro Oliveira', 'senha123', 'alvaro.oliveira@example.com', 1),
...
INSERT INTO tb_comunidade (nm_comunidade, sb_comunidade, id_categoria) 
VALUES ('Comunidade de Automóveis', 'Discutir carros', 3),
...
INSERT INTO tb_lista (nm_lista, dt_criacao, ds_lista, id_categoria, id_usuario) 
VALUES ('Lista de Compras', '2024-04-10', 'Para a semana', 1, 1),
...
INSERT INTO tb_item (nm_item, vl_uni, qt_item, id_status, id_medida, id_lista) 
VALUES ('Maçã', 3.50, 10, 1, 1, 1),
...
INSERT INTO tb_despesas (vl_despesa, dt_despesa, ds_despesa, id_usuario) 
VALUES (150.00, '2024-04-05', 'Compra no supermercado', 1),
...
INSERT INTO tb_comunidade_lista (id_comunidade, id_lista) 
VALUES (1, 6), 
       (2, 3), 
       (3, 2), 
       (4, 5), 
...
INSERT INTO tb_comunidade_usuario (id_comunidade, id_usuario) 
VALUES (1, 1), 
       (2, 2), 
       (3, 3), 
       (4, 4), 
...
INSERT INTO tb_endereco_usuario (id_endereco, id_usuario) 
VALUES (1, 1), 
       (2, 2), 
       (3, 3), 
       (4, 4), 
...
INSERT INTO tb_endereco_comunidade (id_endereco, id_comunidade) 
VALUES (1, 1), 
       (2, 2), 
       (3, 3), 
       (4, 4), 
...
INSERT INTO tb_endereco_lista (id_endereco, id_lista) 
VALUES (1, 1), 
       (2, 2), 
       (3, 3), 
       (4, 4), 
